...
# Based on read_write_node.py example from dynamixel_sdk_examples by Robotis.
# Modified for flexible parameter-based configuration with AX-12A defaults, and different protocol settings.
